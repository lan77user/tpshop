...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <h1>
            <span class="action-span"><a href="{:U('admin/Goods/goodsAdd')}">添加新商品</a></span>
            <span class="action-span1"><a href="{:U('admin/Index/index')}">ECSHOP 管理中心</a></span>
                    ...
                    <?php foreach ($row as $key => $val): ?>
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <a href="__CONTROLLER__/goodsEdit?goods_id=<?php echo $val['goods_id']; ?>" title="编辑"><img src="__PUBLIC__/Admin/images/icon_edit.gif" width="16" height="16" border="0" /></a>
                                <a href="__CONTROLLER__/goodsDelete?goods_id=<?php echo $val['goods_id']; ?>" onclick="" title="回收站"><img src="__PUBLIC__/Admin/images/icon_trash.gif" width="16" height="16" border="0" /></a></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
