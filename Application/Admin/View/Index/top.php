...
<div id="header-div">
    ...
    <div id="submenu-div">
        <ul>
            ...
            <li><a href="__ACTION__/index" target="">个人设置</a></li>
            <li style="border-right:none"><a href="#">刷新</a></li>
        </ul>
        <div id="send_info">
            <a href="#" target="main-frame" class="fix-submenu">清除缓存</a>
            <span>当前用户：{$Think.session.admin_name}</span>
            <a href="__CONTROLLER__/logout" target="_top" class="fix-submenu" onclick="if (confirm('确定要退出吗？')) return true;else return false;">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
    <ul>
        ...
        <li><a href="{:U('admin/index/index')}" target="main-frame">起始页</a></li>
        <li><a href="{:U('admin/goods/goodsList')}" target="main-frame">商品列表</a></li>
        <li><a href="{:U('admin/order/orderList')}" target="main-frame">订单列表</a></li>
        <li><a href="{:U('admin/user/usermessage')}" target="main-frame">用户评论</a></li>
        <li><a href="{:U('admin/User/userList')}" target="main-frame">会员列表</a></li>
