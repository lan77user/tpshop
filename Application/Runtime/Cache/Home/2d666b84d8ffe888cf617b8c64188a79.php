...
<!-- 顶部导航 start -->
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
                                    <li><?php if(null !== $_SESSION['username']&& null !== $Think.session.userid): ?>欢迎您，<?php echo (session('username')); ?>&nbsp;&nbsp;&nbsp;
                                            <a href="<?php echo U('home/user/logout');?>" target="_top" 
                                               onclick="if (confirm('确定要退出吗？')) return true;else return false;">退出</a>
                                            <?php else: ?>您好，欢迎来到京西！[<a href="<?php echo U('home/user/login');?>">登录</a>]
                                            [<a href="<?php echo U('home/user/register');?>">免费注册</a>]<?php endif; ?>
                                    </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="<?php echo U('home/index/index');?>"><img src="/tpshop/Public/Home/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
				<div class="search_form">
					<div class="form_left fl"></div>
					<form action="" name="serarch" method="get" class="fl">
                                            <input type="text" class="txt" placeholder="请输入商品关键字" /><input type="submit" class="btn" value="搜索" />
					</form>
			...
			<div class="user fl">
				<dl>
					...
					<dd>
						<div class="prompt">
                                                    <?php if(null !== $_SESSION['username']&& null !== $Think.session.userid): echo (session('username')); ?>的个人中心<?php else: ?>您好，请<a href="<?php echo U('home/user/login');?>">登录</a><?php endif; ?>
						</div>
    ...
    <div class="content">
    	<div class="image group">
				<div class="grid images_3_of_1">
					<img src="/tpshop/Public/Home/images/newsimg1.jpg" alt="" />
				</div>
		   ...
		   <div class="image group">
				<div class="grid images_3_of_1">
					<img src="/tpshop/Public/Home/images/newsimg2.jpg" alt="" />
				</div>
				<div class="grid news_desc">
					<h3>Lorem Ipsum is simply dummy text </h3>
		   ...
		   <div class="image group">
				<div class="grid images_3_of_1">
					<img src="/tpshop/Public/Home/images/newsimg3.jpg" alt="" />
				</div>
				<div class="grid news_desc">
					<h3>Lorem Ipsum is simply dummy text </h3>
