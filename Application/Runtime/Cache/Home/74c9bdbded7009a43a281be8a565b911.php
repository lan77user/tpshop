		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl <?php if($show_nav == 0) echo 'cat1'; ?>"> <!-- 非首页，需要添加cat1类 -->
				<div class="cat_hd <?php if($show_nav == 0) echo 'off'; ?>">  <!-- 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，鼠标滑过时展开菜单则将off类换成on类 -->
					...
					<div class="cat item1">
						<h3><a href=""><?php echo ($v0["cat_name"]); ?></a> <b></b></h3>
				...
				<div class="crazy">
					<ul>
						<?php foreach ($crazy as $key => $val):?>
							<li>
								<dl>
									<dt><a href=""><img src="/tpshop/Public/Home/<?php echo $val['goods_img']?>" alt="" /></a></dt>
				...
				<div class="goodslist_wrap">
					<div>
						<ul>
							...
							<li>
								<dl>
									<dt><a href=""><img src="/tpshop/Public/<?php echo $val['goods_img'];?>" alt="" /></a></dt>
									<dd><a href=""><?php echo $val['goods_name'];?></a></dd>
									<dd><span>售价：</span> <strong>￥<?php echo $val['shop_price'];?></strong></dd>
								</dl>
							</li>
