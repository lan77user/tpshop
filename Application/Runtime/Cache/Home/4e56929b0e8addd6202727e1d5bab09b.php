...
<!-- 顶部导航 start -->
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到京西！[<a href="<?php echo U('home/user/login');?>">登录</a>] [<a href="<?php echo U('home/user/register');?>">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="<?php echo U('home/index/index');?>"><img src="/tpshop/Public/Home/images/logo.png" alt="京西商城"></a></h2>
		</div>
	</div>
	<!-- 页面头部 end -->
	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
					...
					<ul>
						...
						<li class="checkcode">
							...
							<input type="text"  name="checkcode" />
                                                        <img src="/tpshop/index.php/Home/User/verifyImg" alt="" onclick="this.src='/tpshop/index.php/Home/User/verifyImg/'+Math.random();" style="cursor: pointer;"/>
							<span>看不清？<a href="">换一张</a></span>
                                                        <p style="color: red;"><?php echo ($verifyError); ?></p>
						</li>
			...
			<div class="guide fl">
				...
				<a href="<?php echo U('home/user/register');?>" class="reg_btn">免费注册 >></a>
			</div>
