	...
	<div class="login w990 bc mt10 regist">
		...
		<div class="login_bd">
			<div class="login_form fl">
				<form action="/tpshop/index.php/home/user/register.html" method="post">
					<ul>
						<li>
							<label for="">用户名：</label>
						...
						<li class="checkcode">
							...
							<input type="text"  name="checkcode" />
                                                        <img src="/tpshop/index.php/Home/User/verifyImg" onclick="this.src='/tpshop/index.php/Home/User/verifyImg/'+Math.random()"alt="" style="cursor: pointer;"/>
