 ...
 <div class="main">
    	...
    	<div class="section group">
						   ...
						   <div id="products_example">
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="/tpshop/Public/Home/images/productslide-1.jpg" alt=" " /></a>
									<a href="#" target="_blank"><img src="/tpshop/Public/Home/images/productslide-2.jpg" alt=" " /></a>
									<a href="#" target="_blank"><img src="/tpshop/Public/Home/images/productslide-3.jpg" alt=" " /></a>					
									<a href="#" target="_blank"><img src="/tpshop/Public/Home/images/productslide-4.jpg" alt=" " /></a>
									<a href="#" target="_blank"><img src="/tpshop/Public/Home/images/productslide-5.jpg" alt=" " /></a>
									<a href="#" target="_blank"><img src="/tpshop/Public/Home/images/productslide-6.jpg" alt=" " /></a>
								</div>
								<ul class="pagination">
									<li><a href="#"><img src="/tpshop/Public/Home/images/thumbnailslide-1.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="/tpshop/Public/Home/images/thumbnailslide-2.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="/tpshop/Public/Home/images/thumbnailslide-3.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="/tpshop/Public/Home/images/thumbnailslide-4.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="/tpshop/Public/Home/images/thumbnailslide-5.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="/tpshop/Public/Home/images/thumbnailslide-6.jpg" alt=" " /></a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="share-desc">
					<div class="share">
						<p>Share Product :</p>
						<ul>
					    	<li><a href="#"><img src="/tpshop/Public/Home/images/facebook.png" alt="" /></a></li>
					    	<li><a href="#"><img src="/tpshop/Public/Home/images/twitter.png" alt="" /></a></li>					    
			    		</ul>
					</div>
			...
			<div id="horizontalTab">
				...
				<div class="review">
					<h4>Lorem ipsum Review by <a href="#">Finibus Bonorum</a></h4>
					 <ul>
					 	<li>Price :<a href="#"><img src="/tpshop/Public/Home/images/price-rating.png" alt="" /></a></li>
					 	<li>Value :<a href="#"><img src="/tpshop/Public/Home/images/value-rating.png" alt="" /></a></li>
					 	<li>Quality :<a href="#"><img src="/tpshop/Public/Home/images/quality-rating.png" alt="" /></a></li>
					 </ul>
					 <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
   ...
   <div class="section group">
				<div class="grid_1_of_4 images_1_of_4">
					 <a href="#"><img src="/tpshop/Public/Home/images/new-pic1.jpg" alt=""></a>					
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="#"><img src="/tpshop/Public/Home/images/new-pic2.jpg" alt=""></a>
					 <div class="price" style="border:none">
					       		<div class="add-cart" style="float:none">								
									<h4><a href="#">Add to Cart</a></h4>
							     </div>
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="#"><img src="/tpshop/Public/Home/images/new-pic4.jpg" alt=""></a>
					<div class="price" style="border:none">
					       		<div class="add-cart" style="float:none">								
									<h4><a href="#">Add to Cart</a></h4>
							     </div>
				...
				<div class="grid_1_of_4 images_1_of_4">
				 <img src="/tpshop/Public/Home/images/new-pic3.jpg" alt="">
					 <div class="price" style="border:none">
					       		<div class="add-cart" style="float:none">								
									<h4><a href="#">Add to Cart</a></h4>
							     </div>
