			                    ...
			                    <div id="mover">
			                    	<div id="slide-1" class="slide">			                    
									 <div class="slider-img">
									     <a href=""><img src="/tpshop/Public/Home/images/slide-1-image.png" alt="learn more" /></a>									    
									  </div>
									  ...
									  <div class="clear"></div>				
									   ...
									   <div class="features_list">
							             ...
							             <a href="" class="button">Shop Now</a>
						             	 ...
						             	 <div class="slider-img">
									     <a href=""><img src="/tpshop/Public/Home/images/slide-3-image.jpg" alt="learn more" /></a>
									  </div>						             					                 
									  <div class="clear"></div>				
				                  </div>
				                  <div class="slide">						             	
					                  <div class="slider-img">
									     <a href=""><img src="/tpshop/Public/Home/images/slide-2-image.jpg" alt="learn more" /></a>
									  </div>
									  <div class="slider-text">
		                                 <h1>Clearance<br><span>SALE</span></h1>
		                                 <h2>UPTo 10% OFF</h2>
    	...
    	<div class="content_top">
	      ...
	      <div class="section group">
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="<?php echo U('home/index/preview');?>"><img src="/tpshop/Public/Home/<?php echo $val['goods_img'];?>" alt="" /></a>
					 <h2><?php echo $val['goods_name'];?></h2>
					 <div class="price-details">
				       <div class="price-number">
							<p><span class="rupees">$<?php echo $val['shop_price'];?></span></p>
					    </div>
					       		<div class="add-cart">								
									<h4><a href="<?php echo U('home/index/preview');?>">Add to Cart</a></h4>
							     </div>
							 <div class="clear"></div>
					</div>
				</div>
