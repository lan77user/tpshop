	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
                                    <li><?php if(null !== $Think.session.username): ?>欢迎您，<?php echo (session('username')); ?>&nbsp;&nbsp;&nbsp;<a href="<?php echo U('home/user/logout');?>">退出</a><?php else: ?>您好，欢迎来到京西！[<a href="<?php echo U('home/user/login');?>">登录</a>] [<a href="<?php echo U('home/user/register');?>">免费注册</a>]<?php endif; ?></li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
		...
		<div class="logo w1210">
			...
			<div class="user fl">
				<dl>
					...
					<dd>
						<div class="prompt">
                                                    <?php if(null !== $Think.session.username): echo (session('username')); ?>的个人中心<?php else: ?>您好，请<a href="<?php echo U('home/user/login');?>">登录</a><?php endif; ?>
						</div>
