...
.explode {
  background:url(/tpshop/Public/Admin/images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/tpshop/Public/Admin/images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/tpshop/Public/Admin/images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/tpshop/Public/Admin/images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
<?php foreach ($power_info_father as $k => $v):?>
    <div id="menu-list">
        <ul id="menu-ul">
            <li class="explode" key="02_cat_and_goods" name="menu">
            <?php echo ($v["power_name"]); ?>
                <?php foreach ($power_info_son as $key => $val): if ($val['power_pid'] == $v['power_id']) :?>
                <ul>
                    <li class="menu-item"><a href="/tpshop/index.php/Admin/<?php echo ($val["power_c"]); ?>/<?php echo ($val["power_a"]); ?>" target="main-frame"><?php echo ($val["power_name"]); ?></a></li>
                </ul><?php endif;?>
                <?php endforeach;?>
            </li>
        </ul>
...
<script type="text/javascript" src="/tpshop/Public/Admin/js/global.js"></script>
<script type="text/javascript" src="/tpshop/Public/Admin/js/utils.js"></script>
<script type="text/javascript" src="/tpshop/Public/Admin/js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/tpshop/Public/Admin/images/menu_minus.gif' : '/tpshop/Public/Admin/images/menu_plus.gif';
    ...
    document.getElementById('menu-list').onclick = function(e) {
        ...
        console.log(obj.childNodes[3].style.display);
